...
export const macbookProCart = React.createContext();
...
const MacbookProCartContextProvider = ({ children }) => {
...
export default MacbookProCartContextProvider;
